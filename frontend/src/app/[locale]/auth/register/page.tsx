    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-surface-900 to-surface-950 items-center justify-center p-12">
        ...
        >
          ...
          <h2 className="text-3xl font-bold mb-4">{t('home.titleHighlight')}</h2>
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 text-start">
            <div className="p-4 rounded-xl bg-surface-800/50">
              ...
              <div className="font-medium">{t('home.features.processing.title')}</div>
              <div className="text-sm text-surface-400">{t('home.features.processing.description').substring(0, 50)}...</div>
            </div>
            <div className="p-4 rounded-xl bg-surface-800/50">
              <div className="text-2xl mb-2">🔒</div>
              <div className="font-medium">{t('home.features.aiReady.title')}</div>
              <div className="text-sm text-surface-400">{t('home.features.aiReady.description').substring(0, 50)}...</div>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <h1 className="text-3xl font-bold mb-2">{t('auth.createYourAccount')}</h1>
          <p className="text-surface-400 mb-8">{t('auth.joinUs')}</p>
