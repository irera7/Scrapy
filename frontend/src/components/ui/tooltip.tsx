...
// Simple Tooltip component with content prop for easy usage
...
function Tooltip({ content, children, side = 'top', sideOffset = 4 }: TooltipProps) {
  return (
    <TooltipProvider>
      <TooltipRoot>
